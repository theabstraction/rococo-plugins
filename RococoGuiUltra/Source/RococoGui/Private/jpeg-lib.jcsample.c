...
// Origin: D:/work/rococo/source/3rd-Party/libjpg/jpeg-6b/jcsample.c
/*
 * jcsample.c
 *
		...
		JSAMPARRAY input_data, JSAMPARRAY output_data)
{
  ...
  for (outrow = 0; outrow < compptr->v_samp_factor; outrow++) {
	...
	for (h = 0; h < h_expand; h++) {
	  outvalue += (JTYPE_INT32) GETJSAMPLE(*inptr++);
	}
      }
			...
			JSAMPARRAY input_data, JSAMPARRAY output_data)
{
  ...
  JTYPE_INT32 membersum, neighsum, memberscale, neighscale;
