...
// Origin: D:/work/rococo/source/3rd-Party/libjpg/jpeg-6b/jfdctfst.c
/*
 * jfdctfst.c
 *
...
#if CONST_BITS == 8
#define FIX_0_382683433  ((JTYPE_INT32)   98)		/* FIX(0.382683433) */
#define FIX_0_541196100  ((JTYPE_INT32)  139)		/* FIX(0.541196100) */
#define FIX_0_707106781  ((JTYPE_INT32)  181)		/* FIX(0.707106781) */
#define FIX_1_306562965  ((JTYPE_INT32)  334)		/* FIX(1.306562965) */
#else
