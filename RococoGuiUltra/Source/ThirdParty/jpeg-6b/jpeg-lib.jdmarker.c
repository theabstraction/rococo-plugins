...
// Origin: D:/work/rococo/source/3rd-Party/libjpg/jpeg-6b/jdmarker.c
/*
 * jdmarker.c
 *
 ...
 * V should be declared unsigned int or perhaps JTYPE_INT32.
 */
...
/* Process a DHT marker */
{
  ...
  while (length > 16) {
     ...
     */
    if (count > 256 || ((JTYPE_INT32) count) > length)
...
examine_app0 (j_decompress_ptr cinfo, JOCTET FAR * data,
	      unsigned int datalen, JTYPE_INT32 remaining)
/* Examine first few bytes from an APP0.
 * Take appropriate action if it is a JFIF marker.
 * datalen is # of bytes at data[], remaining is length of rest of marker data.
 */
{
  JTYPE_INT32 totallen = (JTYPE_INT32) datalen + remaining;
  ...
  if (datalen >= APP0_DATA_LEN &&
    ...
    if (totallen !=
	((JTYPE_INT32)GETJOCTET(data[12]) * (JTYPE_INT32)GETJOCTET(data[13]) * (JTYPE_INT32) 3))
